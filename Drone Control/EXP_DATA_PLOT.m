...
APC.c = 30e-3*cos(pi/6);
BASE.c = 27e-3*cos(pi/6);
...
APC.U = (pi/30) .* APC.rpmmean .* 5*25.4e-3; APC.Re = rho .* APC.U .* APC.c ./ mu;
% BASE.U = (pi/30) .* BASE.rpmmean .* 5*25.4e-3; BASE.Re = rho .* BASE.U .* BASE.c ./ mu;
